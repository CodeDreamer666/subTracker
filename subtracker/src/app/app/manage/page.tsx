                ...
                <Dialog open={scanDialogOpen} onOpenChange={handleScanDialogOpenChange}>
                    <DialogContent className="max-w-2xl">
                        ...
                        {scan.isPending ? (
                            ...
                            <div className="border-line flex justify-between items-center rounded-xl border bg-[#faf9f8] p-5">
                        ...
                        {scan.data && !scan.isPending && !confirmCandidates.isPending ? (
                            <div className="border-line w-full justify-end flex flex-wrap items-center gap-x-2 border-t pt-4 text-sm">
