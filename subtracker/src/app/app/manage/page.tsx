...
function formatCost(
    ...
    const price = formatSubscriptionAmount(amountMinor);
...
export default function SettingsPage() {
    ...
    function handleStartScan() {
        ...
        confirmCandidates.reset();
        setSelectedCandidateIds([]);
        scan.mutate({ period: scanPeriod });
    }

    function handleStartScanFromPage() {
    ...
    async function handleDeleteAccount(
        ...
        try {
            ...
            // The server-side account deletion already invalidated this session.
        }
